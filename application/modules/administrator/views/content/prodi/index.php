...
<div class="box">
  <div class="box-header with-border">
    ...
    <div class='box-tools pull-right'>
      <a href='<?=site_url(config_item("cpanel")."prodi/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
    </div>
  </div>
  ...
  <div class="box-body">
      <div id="alert"></div>
        ...
        <tr>
            ...
            <td><a href="#">prodi/<?php echo $prodi->slug ?></a></td>
						<td style="text-align:center" width="200px">
							<a href="<?=site_url(config_item("cpanel")."prodi/detail/$prodi->id_prodi")?>" id="detail" class="btn btn-sm btn-primary">detail</a>
							<a href="<?=site_url(config_item("cpanel")."prodi/edit/$prodi->id_prodi")?>" id="edit" class="btn btn-sm btn-warning">edit</a>
							<a href="<?=site_url(config_item("cpanel")."prodi/hapus/$prodi->id_prodi")?>" id="hapus" class="btn btn-sm btn-danger">hapus</a>
					</td>
			</tr>
              <?php } ?>
            <tbody>
