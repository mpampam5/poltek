...
<div class='box'>
  <div class='box-header with-border'>
    <h3 class='box-title'>Modul Tombol Aplikasi Terkait</h3>
      <div class='box-tools pull-right'>
        <a href='<?=site_url(config_item("cpanel")."btn_app/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
      </div>
  </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?=base_url(config_item('cpanel'))?>/btn_app/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_btn",
                            "orderable": false
                        ...
                        {"data": "bg_color",
                         render:function(data, type, row, meta){
                          return "<span style='background-color:"+data+";padding:3px;color:#fff'>"+data+"</span>";
                         }
                        },
                        {
                            "data" : "action",
